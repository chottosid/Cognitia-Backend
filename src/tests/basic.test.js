...
describe("Basic Application Tests", () => {
  describe("Environment and Configuration", () => {
    ...
    it("should validate required environment configurations", () => {
      ...
      requiredEnvVars.forEach((envVar) => {
        ...
        expect(envValue === undefined || typeof envValue === "string").toBe(
          true
        );
      });
    });
  ...
  describe("Data Validation", () => {
    it("should validate required fields", () => {
      ...
      expect(validateRequired(validData, ["name", "email", "age"])).toEqual({
        isValid: true,
      });
      expect(validateRequired(invalidData, ["name", "email", "age"])).toEqual({
        isValid: false,
        missing: "email",
      });
    });
